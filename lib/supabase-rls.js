...
export async function getSession() {
  ...
  return {
    user: {
      ...
      // `role` stays DB-sourced for backward compatibility with existing callers.
      // `roles` comes from the verified SSO JWT — the authoritative source of
      // truth for authorization, since skillpassport's users.role/admin_users
      // can be null/unpopulated even for accounts with real SSO admin roles.
