    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="university" className="space-y-6">
        ...
        <TabsContent value="recruiters" className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-semibold">📈 Recruiter Engagement Metrics</h3>
            <div className="flex gap-2">
              <Button 
                variant="outline" 
                size="sm"
        ...
        <TabsContent value="heatmap" className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-semibold">🌍 State/District Heat Map</h3>
            <div className="flex gap-2">
              <Button 
                variant="outline" 
                size="sm"
        ...
        <TabsContent value="insights" className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-semibold">🧠 AI Insight Panel</h3>
            <div className="flex gap-2">
              <Button 
                variant="outline" 
                size="sm"
