...
const RAW_EXPORT_COLUMNS: Record<string, Array<string | TemplateColumn>> = {
  ...
  levels: ['id', 'level_code', 'capability_id', 'level_id', 'title', 'description', { header: 'observable_behavior (|)', source: 'observable_behavior', pipe: true }, 'example_outputs', { header: 'problem_statement (|)', source: 'problem_statement', pipe: true }, 'duration_minutes', 'difficulty_level', 'total_xp'],
